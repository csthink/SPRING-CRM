                        ...
                        <div class="body">
                            ...
                            <form class="needs-validation" id="employee-edit-form" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="real_name" class="form-control" name="real_name" value="${OBJ.realName}" placeholder="请输入真实姓名" required autofocus maxlength="20">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input id="birth_date" data-provide="datepicker" data-date-autoclose="true" class="form-control" name="birth_date" data-date-format="yyyy-mm-dd" value="<fmt:formatDate value="${OBJ.birthDate}" pattern="yyyy-MM-dd"/>">
                                    </div>
                                    <div class="valid-feedback"></div>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="fancy-radio">
                                            <input type="radio" name="gender" value="0" <c:out value="${OBJ.gender == 0 ? 'checked': ''}" />>
                                            <span><i></i>保密</span>
                                        </label>
                                        <label class="fancy-radio">
                                            <input type="radio" name="gender" value="1" <c:out value="${OBJ.gender == 1 ? 'checked': ''}" />>
                                            <span><i></i>男</span>
                                        </label>
                                        <label class="fancy-radio">
                                            <input type="radio" name="gender" value="2" <c:out value="${OBJ.gender == 2 ? 'checked': ''}" />>
                                            <span><i></i>女</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input id="hire_date" data-provide="datepicker" data-date-autoclose="true" class="form-control" name="hire_date" data-date-format="yyyy-mm-dd" value="<fmt:formatDate value="${OBJ.hireDate}" pattern="yyyy-MM-dd"/>">
                                    </div>
                                    <div class="valid-feedback"></div>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="phone_num" class="form-control" name="phone" value="${OBJ.phone}" placeholder="请输入手机号" required>
                                    <div class="valid-feedback"></div>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <br/>
